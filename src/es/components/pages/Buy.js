    ...
    this.html = /* html */`
      <section>
        <header>
          ...
          <h1 class=font-size-h2>Step: Buy Bitcoins</h1>
          <section>
            <div></div>
