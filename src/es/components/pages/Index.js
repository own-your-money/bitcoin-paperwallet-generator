...
*/
export default class Index extends IndexPrototype {
  ...
  */
  renderHTML () {
    ...
    <section>
      <header>
        <img class=oym-img src="${this.importMetaUrl}../../../img/OYM.png" />
        <h1>Welcome to</h1>
      ...
      <main>
        ...
        <div class="cards overview">
          <a class=card href="?page=/production" route target="_self">
            <h4>${this.printerSvg}<br><span>OYM production</span></h4>
          </a>
          <a class=card href="https://github.com/own-your-money/bitcoin-paperwallet-generator" target="_blank">
